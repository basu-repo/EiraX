...
alias failure_injection_manager='px4-failure_injection_manager --instance $px4_instance'
...
alias fw_lat_lon_control='px4-fw_lat_lon_control --instance $px4_instance'
alias fw_mode_manager='px4-fw_mode_manager --instance $px4_instance'
...
alias vision_target_estimator='px4-vision_target_estimator --instance $px4_instance'
